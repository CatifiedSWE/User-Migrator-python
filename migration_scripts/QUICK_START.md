...
### Magic Links CSV Example
```csv
user_id,email,first_name,surname,magic_link,expiry_date
550e8400-...,tinageorge_1@heypro.migration,Tina,George,https://kvidydsfnnrathhpuxye.supabase.co/auth/v1/verify?token=...,2025-01-26
...
```
